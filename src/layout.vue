        ...
        <div class="flex items-center gap-2">
          <n-button-group>
            ...
            <n-button
              ...
              :type="route.name === 'exam' ? 'primary' : 'default'"
            >
            ...
            <n-button
              ...
              :type="route.name === 'user' ? 'primary' : 'default'"
            >
              <template #icon
...
const menuOptions: MenuOption[] = [
  ...
  {
    label: () =>
      h(RouterLink, { to: { name: "exam" } }, { default: () => "模拟考试" }),
    key: "exam",
    icon: renderIcon("i-carbon-exam-mode"),
  },
  {
    label: () =>
      h(RouterLink, { to: { name: "user" } }, { default: () => "成绩证书" }),
    key: "user",
    icon: renderIcon("i-carbon-certificate"),
  },
  {
    label: () =>
      h(RouterLink, { to: { name: "admin" } }, { default: () => "管理员" }),
    key: "admin",
