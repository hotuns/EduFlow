<template>
  <div class="w-full h-full flex flex-col space-y-6 p-4">
    ...
    <div class="flex justify-between items-center">
      ...
      <div class="text-gray-400">总分：{{ totalScore }} 分</div>
    </div>
    ...
    <n-card>
      ...
      <div class="mb-8">
        <div class="text-lg font-bold mb-4 pb-2 border-b">
          选择题（每题{{ questionScores.choice }}分，共{{
            choiceQuestions.length * questionScores.choice
          }}分）
        </div>
        <n-form
          ref="choiceFormRef"
      ...
      <!-- <div class="mb-8">
        ...
        >
          <div
            v-for="(question, index) in expandQuestions"
            :key="question.id"
            class="mb-8"
          >
            <n-form-item
      ...
      <div class="mb-8">
        <div class="text-lg font-bold mb-4 pb-2 border-b">
          判断题（每题{{ questionScores.judgment }}分，共{{
            judgmentQuestions.length * questionScores.judgment
          }}分）
        </div>
        <n-form
          ref="judgmentFormRef"
        ...
        >
          ...
          >
            ...
            >
              <n-radio-group
                v-model:value="answers.judgment[`q${question.id}`]"
              >
                <n-space>
      ...
      <!-- <div class="mb-8">
        ...
        >
          ...
          >
            ...
            >
              <n-checkbox-group
                v-model:value="answers.multiple[`q${question.id}`]"
              >
                <n-space vertical>
                  <n-checkbox
                    v-for="option in question.options"
      ...
      <!-- <div class="mb-8">
        ...
        <n-form ref="fillFormRef" :model="answers.fill" :rules="fillRules">
          <div
            v-for="(question, index) in fillQuestions"
            :key="question.id"
            class="mb-8"
          >
            <n-form-item
            ...
            >
              <n-input
                v-model:value="answers.fill[`q${question.id}`]"
                type="text"
                placeholder="请输入答案"
              />
            </n-form-item>
      ...
      <!-- <div class="mb-8">
        ...
        <n-form ref="essayFormRef" :model="answers.essay" :rules="essayRules">
          ...
          >
            ...
            >
              <n-input
                v-model:value="answers.essay[`q${question.id}`]"
                type="textarea"
                placeholder="请输入你的答案"
                :rows="4"
              />
    ...
    >
              ...
              <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <span class="text-gray-500"
                    >/
                    {{ choiceQuestions.length * questionScores.choice }}</span
                  >
                </div>
              </div>
            ...
            <div v-if="choiceQuestions.length">
              ...
              <div class="space-y-4">
                <div
                  ...
                  :class="
                    isAnswerCorrect('choice', question)
            ...
            <div v-if="judgmentQuestions.length">
              ...
              <div class="space-y-4">
                <div
                  ...
                  class="p-4 rounded-lg"
                  :class="
                    isAnswerCorrect('judgment', question)
                      ? 'dark:bg-green-900/20'
                      : 'dark:bg-red-900/20'
                  "
                >
                  <div class="flex items-start justify-between">
                    <div>
                      ...
                      <div class="text-sm dark:text-gray-400">
                        您的答案：{{
                          answers.judgment[`q${question.id}`] === "true"
                            ? "正确"
                            : "错误"
                        }}
                      </div>
            ...
            <div v-if="multipleQuestions.length">
              ...
              <div class="space-y-4">
                <div
                  ...
                  class="p-4 rounded-lg"
                  :class="
                    isAnswerCorrect('multiple', question)
                      ? 'dark:bg-green-900/20'
                      : 'dark:bg-red-900/20'
                  "
                >
              ...
              <div class="space-y-4">
                ...
                >
                  <div class="flex items-start justify-between">
                    ...
                    <n-tag
                      :type="
                        isAnswerCorrect('fill', question) ? 'success' : 'error'
                      "
                    >
                ...
                >
                  <div>
                    ...
                    <div class="text-sm text-emerald-500">
                      得分：{{ getEssayScore(question) }} /
                      {{ questionScores.essay }}
                    </div>
      ...
      <template #footer>
        <div class="flex justify-center">
          <n-button type="primary" @click="handleNext"> 查看证书 </n-button>
        </div>
      </template>
    </n-modal>
  </div>
...
const expandFormRef = ref<FormInst | null>(null);
...
const calculateEssayScore = (answer: string, keywords: string[]) => {
  ...
  console.log("简答题得分计算:", {
    ...
    unmatchedKeywords: lowerKeywords.filter(
